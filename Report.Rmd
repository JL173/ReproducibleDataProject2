...
To build a visual, we will adjust the dataframe. Trim to just the top 20 contributing events, sorted by sum of damages. Then collapse fatalities and injuries into one column but associating a label with each for ggplot to interpret.
